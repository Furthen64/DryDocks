...
DryDocks provides automated testing for LLM API compatibility across seven levels of complexity:
...
7. **Repo Debugging Test** — Coordinate edits and repairs in a larger seeded repo
